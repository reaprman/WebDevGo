...
import (
	...
	"github.com/reaprman/WebDevGo/42_mongodb/05_mongodb/05_update-user-controller-delete/models"
	"gopkg.in/mgo.v2"
...
func (uc UserController) DeleteUser(w http.ResponseWriter, r *http.Request, p httprouter.Params) {
	...
	oid := bson.ObjectIdHex(id)
	// delete user
	if err := uc.session.DB("go-webdev-go").C("users").RemoveId(oid); err != nil {
		w.WriteHeader(404)
		return
	}
	w.WriteHeader(http.StatusOK) // 200
